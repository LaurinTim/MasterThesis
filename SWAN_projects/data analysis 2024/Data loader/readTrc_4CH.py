    ...
    def open(self, fName):
        ...
        with open(fName, "rb") as f:
            ...
            for i in range(4):
                ...
                #print(f.tell(), temp)
                # offset to start of WAVEDESC block
                self._offs = temp.find(b'WAVEDESC')+ch_offset
                #print(self._offs)
                # -------------------------------
                #  Read WAVEDESC block
                # -------------------------------
                ...
                if self._smplFmt == "int16":
                    self._lWAVE_ARRAY_1 = self._readX("l",60) //2
                    self._lWAVE_ARRAY_2 = self._readX("l",64) //2
                else:
